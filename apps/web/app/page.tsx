...
export default function HomePage() {
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Hero Section */}
      <section className="px-6 py-20 text-center bg-gradient-to-b from-brand-25 to-white animate-in fade-in slide-in-from-top-2 duration-500">
        <div className="max-w-4xl mx-auto">
          <div className="inline-flex items-center px-3 py-1 mb-6 text-sm text-brand-700 bg-brand-100 rounded-full">
      ...
      {/* How It Works */}
      <section className="px-6 py-16 bg-gray-50 animate-in fade-in slide-in-from-bottom-2 duration-500">
        <div className="max-w-6xl mx-auto text-center">
          <p className="text-brand-700 font-semibold mb-4">HOW IT WORKS</p>
      ...
      {/* Features */}
      <section id="features" className="px-6 py-16 animate-in fade-in zoom-in-95 duration-500">
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-3 gap-8">
            <div className="p-8 border border-gray-200 rounded-lg hover:shadow-lg transition-shadow">
              <p className="text-brand-700 font-semibold mb-2">FEATURE</p>
      ...
      <section className="px-6 py-16 bg-gray-50">
        <div className="max-w-6xl mx-auto text-center">
          <p className="text-brand-700 font-semibold mb-4">METRICS</p>
      ...
      <section className="px-6 py-16">
        <div className="max-w-6xl mx-auto text-center">
          <p className="text-brand-700 font-semibold mb-4">TESTIMONIALS</p>
